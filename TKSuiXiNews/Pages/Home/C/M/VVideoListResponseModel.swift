...
//
//   let vVideoListModel = try? newJSONDecoder().decode(VVideoListModel.self, from: jsonData)

import Foundation

// MARK: - VVideoListModel
struct VVideoListResponseModel: Codable {
    let code: Int
    let msg, time: String
    let data: VVideoListDataModel
}

// MARK: - DataClass
struct VVideoListDataModel: Codable {
    let total, perPage, currentPage, lastPage: Int
    let data: [VVideoListModel]
...
// MARK: - Datum
struct VVideoListModel: Codable {
