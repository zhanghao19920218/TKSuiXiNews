...
class SXHomeTVOtherSectionCollectionCell: UICollectionViewCell {
    var title:String? {
        willSet(newValue) {
            view.title = newValue
        }
    ...
    private lazy var view: SXHomeTVDetailPlayerView = {
...
class HomeTVOtherSectionCell: BaseTableViewCell {
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        collectionView.register(SXHomeTVOtherSectionCollectionCell.self, forCellWithReuseIdentifier: cellIdentifier)
...
extension HomeTVOtherSectionCell: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: cellIdentifier, for: indexPath) as! SXHomeTVOtherSectionCollectionCell
