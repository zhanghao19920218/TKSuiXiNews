...
fileprivate let articleContentWebIdentifier = "HomeArticleContentWebCellIdentifier"
...
class VideoNewsDetailController: SXBaseViewController {
    ...
    private lazy var tableView: UITableView = {
        ...
        tableView.register(HomeArticleContentWebCell.self, forCellReuseIdentifier: articleContentWebIdentifier)
...
extension VideoNewsDetailController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        //用户发表内容
        if indexPath.row == 2 {
            let cell = tableView.dequeueReusableCell(withIdentifier: articleContentWebIdentifier) as! HomeArticleContentWebCell
