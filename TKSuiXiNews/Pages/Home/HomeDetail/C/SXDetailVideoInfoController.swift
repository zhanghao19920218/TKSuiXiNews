...
fileprivate let userAvatarIdentifier = "DetailUserInfoAvatarCellIdentifier"
fileprivate let userNameCellIdentifier = "DetailUserInfoNameCellIdentifier"
fileprivate let vvideoInfoViewIdentifier = "DetailVVideoInfoCellIdentifier"
fileprivate let shareBottomCellIdentifier = "BaseShareBottomViewIdentifier"
fileprivate let commentLikeCellIdentifier = "DetailCommentLikeNumCellIdentifier"
fileprivate let commentCellIdentifier = "DetailUserCommentCellIdentifier"
fileprivate let voteInfoCellIdentifier = "DetailInfoVoteSectionCellIdentifier" //投票的Cell

///V视频详情的viewController
class SXDetailVideoInfoController: SXBaseViewController {
    ...
    private lazy var tableView: UITableView = {
        ...
        tableView.register(SXDetailUserInfoAvatarCell.self, forCellReuseIdentifier: userAvatarIdentifier)
        tableView.register(SXDetailUserInfoNameCell.self, forCellReuseIdentifier: userNameCellIdentifier)
        tableView.register(SXDetailVVideoInfoCell.self, forCellReuseIdentifier: vvideoInfoViewIdentifier)
        tableView.register(BaseShareBottomView.self, forCellReuseIdentifier: shareBottomCellIdentifier);
        tableView.register(SXDetailCommentLikeNumCell.self, forCellReuseIdentifier: commentLikeCellIdentifier)
        tableView.register(SXDetailUserCommentCell.self, forCellReuseIdentifier: commentCellIdentifier)
        tableView.register(DetailInfoVoteSectionCell.self, forCellReuseIdentifier: voteInfoCellIdentifier) //投票的Cell
        return tableView;
    }();
...
extension SXDetailVideoInfoController {
    //MARK: - 获取新闻详情
...
extension SXDetailVideoInfoController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        //用户头像时间
        if indexPath.row == 0 {
            let cell = tableView.dequeueReusableCell(withIdentifier: userAvatarIdentifier) as! SXDetailUserInfoAvatarCell
        ...
        //用户发表内容
        if indexPath.row == 1 {
            let cell = tableView.dequeueReusableCell(withIdentifier: userNameCellIdentifier) as! SXDetailUserInfoNameCell
        ...
        //用户视频页面
        if indexPath.row == 2 {
            let cell = tableView.dequeueReusableCell(withIdentifier: vvideoInfoViewIdentifier) as! SXDetailVVideoInfoCell
        ...
        if let detailModel = model, detailModel.voteID.int != 0 {
            //是不是用户投票的界面
            if indexPath.row == 3 {
                let cell = tableView.dequeueReusableCell(withIdentifier: voteInfoCellIdentifier) as! DetailInfoVoteSectionCell
                if let _ = voteModel {
            ...
            //用户称赞数量和评论数量
            if indexPath.row == 5 {
                let cell = tableView.dequeueReusableCell(withIdentifier: commentLikeCellIdentifier) as! SXDetailCommentLikeNumCell
...
//MARK: - 分享成功回调
extension SXDetailVideoInfoController: QQShareInstanceDelegate, ThirdPartyLoginDelegate {
