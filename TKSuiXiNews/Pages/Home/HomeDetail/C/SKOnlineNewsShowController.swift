...
fileprivate let sxvideoPlayIdentifier = "VideoNewsDetailInfoCellIdentifier"
fileprivate let sxarticleTitleIdentifier = "OnlineShowTitleReviewCellIdentifier"
...
fileprivate let sxarticleWebContentIdentifier = "HomeArticleContentWebCellIdentifier" //新闻内容的Cell
fileprivate let sxshareCellIdentifier = "BaseShareBottomViewIdentifier"

///直播详情页面
class SKOnlineNewsShowController: SXBaseViewController {
    //动态调整的webView高度
    ...
    private lazy var _tableView: UITableView = {
        ...
        tableView.register(SXVideoNewsDetailInfoCell.self, forCellReuseIdentifier: sxvideoPlayIdentifier)
        tableView.register(SXOnlineShowTitleReviewCell.self, forCellReuseIdentifier: sxarticleTitleIdentifier)
        ...
        tableView.register(SXHomeArticleContentWebCell.self, forCellReuseIdentifier: sxarticleWebContentIdentifier)
    ...
    private lazy var _commentView: SXOnlineSendCommentView = {
        let view = SXOnlineSendCommentView()
    ...
    private func setupUI() {
        ...
        _commentView.snp.makeConstraints { (make) in
...
extension SKOnlineNewsShowController {
    //MARK: - 获取新闻详情
...
extension SKOnlineNewsShowController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        //播放视频信息
        if indexPath.row == 0 {
            let cell = tableView.dequeueReusableCell(withIdentifier: sxvideoPlayIdentifier) as! SXVideoNewsDetailInfoCell
        ...
        //视频信息界面
        if indexPath.row == 1 {
            let cell = tableView.dequeueReusableCell(withIdentifier: sxarticleTitleIdentifier) as! SXOnlineShowTitleReviewCell
        ...
        //直播具体内容的信息
        if indexPath.row == 2 {
            let cell = tableView.dequeueReusableCell(withIdentifier: sxarticleWebContentIdentifier) as! SXHomeArticleContentWebCell
...
//MARK: - 分享成功回调
extension SKOnlineNewsShowController: QQShareInstanceDelegate, ThirdPartyLoginDelegate {
