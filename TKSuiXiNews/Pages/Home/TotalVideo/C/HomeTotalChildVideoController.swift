...
fileprivate let cellIdentifier = "HomeTotalCollectionCellIdentifier"

class HomeTotalChildVideoController: BaseCollectionViewController {
    ...
    private func _setupUI() {
        ...
        collectionView.register(HomeTotalCollectionCell.self, forCellWithReuseIdentifier: cellIdentifier)
    ...
    override func pullDownRefreshData() {
        ...
        HttpClient.shareInstance.request(target: BAAPI.secondModule(module: "濉溪TV", module_second: secondModule, page: page), success:{ [weak self] (json) in
            ...
            let model = try? decoder.decode(TVSecondModuleResponse.self, from: json)
...
extension HomeTotalChildVideoController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let model = dataSource[indexPath.row] as! TVSecondModuleDatum
...
extension HomeTotalChildVideoController {
    //MARK: - 请求首页数据
