...
struct SXTVSecondModuleResponse: Codable {
    let code: Int
    let msg, time: String
    let data: SXTVSecondModuleData
}

// MARK: - DataClass
struct SXTVSecondModuleData: Codable {
    let total, perPage, currentPage, lastPage: Int
    let data: [SXSecondModuleModel]
...
// MARK: - Datum
struct SXSecondModuleModel: Codable {
