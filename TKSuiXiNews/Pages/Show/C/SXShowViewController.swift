...
fileprivate let sxtextImageIdentifier = "ShowImageTextCellIdentifier"
fileprivate let sxvideoIdentifier = "ShowVideoViewCellIdentifier"

///随手拍Controller
class SXShowViewController: BaseTableViewController {
    //设置右侧的navigationItem
    private lazy var _rightNavigatorItem: BaseNaviRightButton = {
    ...
    private func setupUI() {
        tableView.register(TKSXShowImageTextCell.self, forCellReuseIdentifier: sxtextImageIdentifier);
        tableView.register(TKSXShowVideoViewCell.self, forCellReuseIdentifier: sxvideoIdentifier)
...
extension SXShowViewController {
    //MARK: - 请求首页数据
...
extension SXShowViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if model.images.count == 0 {
            let cell = tableView.dequeueReusableCell(withIdentifier: sxvideoIdentifier) as! TKSXShowVideoViewCell;
            ...
            let cell = tableView.dequeueReusableCell(withIdentifier: sxtextImageIdentifier) as! TKSXShowImageTextCell
...
//MARK: - 点击跳转拍摄V视频和拍照
extension SXShowViewController: FWPopupViewUtilDelegate {
...
extension SXShowViewController: YPImagePickerUtilDelegate {
