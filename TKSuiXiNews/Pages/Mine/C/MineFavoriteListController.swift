...
class MineFavoriteListController: BaseTableViewController {
...
extension MineFavoriteListController: UITableViewDelegate, UITableViewDataSource {
...
extension MineFavoriteListController {
    //MARK: - 请求首页数据
