...
fileprivate let cellIdentifier = "MineIntegralDetailTableViewCellIdentifier"

///我的兑换记录的Controller
class SXMineIntegralDetailViewController: BaseTableViewController {
    ///用户上方的imageView
    ...
    private func setupUI() {
        ...
        tableView.register(SXMineIntegralDetailCell.self, forCellReuseIdentifier: cellIdentifier)
    }
...
extension SXMineIntegralDetailViewController : UITableViewDelegate,UITableViewDataSource{
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return dataSource.count
    }
    
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: cellIdentifier) as! SXMineIntegralDetailCell
...
extension SXMineIntegralDetailViewController {
    //MARK: - 请求首页数据
    ...
    //积分数据
    private func getDetailExchangeScore(){
