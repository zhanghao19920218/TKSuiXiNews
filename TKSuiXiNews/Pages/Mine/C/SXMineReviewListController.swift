...
class SXMineReviewListController: BaseTableViewController {
...
extension SXMineReviewListController: UITableViewDelegate, UITableViewDataSource {
...
extension SXMineReviewListController {
    //MARK: - 请求首页数据
