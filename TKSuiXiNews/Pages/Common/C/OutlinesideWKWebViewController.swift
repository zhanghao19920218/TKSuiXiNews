//
//  OutlinesideWKWebViewController.swift
//  TKSuiXiNews
//
//  Created by Barry Allen on 2019/8/30.
...
class OutlinesideWKWebViewController: SXBaseViewController {
    ...
    private lazy var rightNavigatorItem: UIButton = {
        ...
        button.setImage(K_ImageName("share_article_item"), for: .normal);
        button.frame = CGRect(x: 0, y: 0, width: 30 * iPHONE_AUTORATIO, height: 30 * iPHONE_AUTORATIO)
        button.addTarget(self, action: #selector(shareVideoNewsInfo), for: .touchUpInside)
        return button
    }()
...
extension OutlinesideWKWebViewController: WKUIDelegate, WKNavigationDelegate {
    ...
    ///点击分享视频播放按钮
    @objc private func shareVideoNewsInfo() {
