...
// MARK: 修改返回按钮
- (void)addBackImageBtnInTopBar{
    UIButton *backB = [UIButton buttonWithType:UIButtonTypeCustom];
    [backB setImage:[UIImage imageNamed:@"token_back_main"] forState:UIControlStateNormal];
    [backB setImageEdgeInsets:UIEdgeInsetsMake(0, -30, 0, 0)];
    backB.frame = CGRectMake(0, 0, 44, 44);
    [backB addTarget:self action:@selector(popViewControllerBtnPressed) forControlEvents:UIControlEventTouchUpInside];
    UIBarButtonItem *item = [[UIBarButtonItem alloc] initWithCustomView:backB];
    [self.navigationItem setLeftBarButtonItem:item];
}

- (void)popViewControllerBtnPressed
{
